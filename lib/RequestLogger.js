...
class RequestLogger {
    ...
    /**
     * This function adds a Log Entry to the logger's buffer. If the level is
     * high enough to trigger an immediate write or a full dump, it proceeds
     * with the I/O operation.
     *
     * @private
     *
     * @param {string} level       - The log level of the log entry.
     * @param {string} msg         - The message to be printed.
     * @param {object} [logFields] - Additional JSON fields for this entry.
     * @param {boolean} [isEnd]    - Flag indicating this is the final log entry.
     *
     * @returns {undefined}
     */
    log(level, msg, logFields, isEnd) {
        ...
        // OPTIMIZATION: Create a lightweight entry with raw data.
        // The full object is assembled later in doLogIO if needed.
        const logEntry = {
            level,
            msg,
            logFields,
     ...
     */
    doLogIO(logEntry) {
        // OPTIMIZATION: Assemble the final log object here, just before I/O.
        ...
        case 'fatal':
            ...
            break;
        default:
            // This path should not be reachable with validated log levels.
