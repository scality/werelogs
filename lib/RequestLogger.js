...
class RequestLogger {
    ...
    doLogIO(logEntry) {
        ...
        case 'trace':
            this.bLogger.trace(this.fields, logEntry.msg);
            break;
        case 'debug':
            this.bLogger.debug(this.fields, logEntry.msg);
            break;
        case 'info':
            this.bLogger.info(this.fields, logEntry.msg);
            break;
        case 'warn':
            this.bLogger.warn(this.fields, logEntry.msg);
            break;
        case 'error':
            this.bLogger.error(this.fields, logEntry.msg);
            break;
        case 'fatal':
            this.bLogger.fatal(this.fields, logEntry.msg);
            break;
        default:
