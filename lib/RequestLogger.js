...
class RequestLogger {
     ...
     * @param { string[] | string | undefined } uids
     *                                  An Unique Id in a String format or
     *                                  Unique ID List of the parent request
     *                                  IDs. Any String of the UID shall not
     *                                  contain any colon, due to the
     *                                  serialization format chosen for the UID
     *                                  List. This parameter is _OPTIONAL_.
     */
    constructor(logger, logLevel, dumpThreshold, uids) {
     ...
     *
     * @returns     A copy of the internal array of UIDs. It shall never be
     ...
     *
     * @returns                 The previous set of default fields (can be
     *                          safely ignored).
     */
