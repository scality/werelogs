...
class RequestLogger {
    ...
    /**
     *  This function creates a new RequestLogger object from a ModuleLogger
     *  already existing in order to have the submodule field from the
     *  ModuleLogger.
     *
     *	@param {ModuleLogger} ml - The base ModuleLogger
     *	@return {RequestLogger} - The new RequestLogger created
     *				  with the ModuleLogger
     */
    scope(ml) {
        return ml.newRequestLogger(this.getUids());
    }
