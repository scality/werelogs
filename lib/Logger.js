...
class Logger {
     ...
     *
     * @param {string} submodule - The name of the sub module using this
     *                                 logger. It can be found later on in the
     *                                 log entries.
     *
     ...
     * @returns {undefined}
     */
    constructor(name, config, submodule) {
        this.name = name;
